...
public class BookService : IBookService
{
    ...
    public async Task<IEnumerable<BookResponseDto>> GetAllBooksAsync()
    {
        ...
        return books.Select(b => new BookResponseDto(b.Id, b.Title, b.Author, b.Description, b.PublishedYear));
    }
    ...
    public async Task<BookResponseDto?> GetBookByIdAsync(int id)
    {
        ...
        return new BookResponseDto(book.Id, book.Title, book.Author, book.Description, book.PublishedYear);
    }
